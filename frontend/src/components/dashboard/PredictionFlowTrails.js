...
export default function PredictionFlowTrails({ count = 50 }) {
    ...
    return (_jsxs("points", { ref: lines, children: [_jsx("bufferGeometry", { children: _jsx("bufferAttribute", { attach: "attributes-position", args: [positions, 3] }) }), _jsx("pointsMaterial", { size: 0.1, color: "#00ffff", transparent: true, opacity: 0.8 })] }));
}
